...
const createInnerHtml = () => {
  ...
  for (const contact of contactList) {
    innerHtml = `${innerHtml} 
        ...
        <td>
            <img src="/assets/icon/delete-black-18dp.svg" alt="delete" id="${contact.id}" onclick="remove(this)">
            <img src="../assets/icon/edit.svg" alt="update" id="${contact.id}" onclick="update(this)">
        </td>
        </tr>`;
  }
